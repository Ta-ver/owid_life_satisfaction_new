...
cantril_chart <- 
  ...
  filter(Year >= 2010) %>%
 # select(Happiness)
  filter(Country %in% c("Norway", "Australia", "India", "Brazil", "Ghana", "South Africa")) %>% 
  #filter(Year == 2010:2022) %>% 
...
function filter_default() {
  var default_countries = ["Norway", "Australia", "India", "Ghana", "South Africa", "Brazil"]; // Set default countries here
